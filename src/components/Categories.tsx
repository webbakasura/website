      ...
      <div className="mx-auto max-w-6xl text-center">
        ...
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-3 gap-4 sm:gap-6">
          {CATEGORIES.map((cat, i) => (
            ...
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gold/10 ring-1 ring-gold-deep/25 transition group-hover:bg-gold/20">
                <cat.icon size={22} className="text-gold-deep" />
              </div>
